...
export class WidgetConfigService {
    ...
    constructor(http: Http) {
        ...
        this.WIDGETCONFIGSERVICE_BASEURL = "http://localhost:4200/assets/";
    ...
    GetData(requrl: string) {
        ...
        this.WIDGETCONFIGSERVICE_PIVOTGRIDCACHEDATAURL = this.WIDGETCONFIGSERVICE_BASEURL + "Data/" + requrl + "/CacheJsonData.json";
        this.WIDGETCONFIGSERVICE_PIVOTGRIDCONFIGDATAURL = this.WIDGETCONFIGSERVICE_BASEURL + "Data/" + requrl + "/ConfigData.json";
